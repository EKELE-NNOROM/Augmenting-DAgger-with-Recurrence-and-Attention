...
ROAD_COLOR = [0.4, 0.4, 0.4] # Original Road track
# ROAD_COLOR = [0.4, 0.3, 0.4] # Experiement 1 - purple
# ROAD_COLOR = [0.4, 0.5, 0.4] # Experiment 2 - green
# ROAD_COLOR = [0.4, 0.4, 0.7] # Experiment 3 - blue
